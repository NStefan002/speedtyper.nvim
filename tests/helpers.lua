...
-- @usage global_equality(child, "_G.SpeedtyperLoaded", true)
...
-- @usage global_type_equality(child, "_G.SpeedtyperLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Speedtyper.config." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.config_type_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(
            child,
            "type(_G.Speedtyper.config." .. field .. ")",
            value
        )
    end,
    errorMessage
...
Helpers.expect.state_equality = MiniTest.new_expectation(
    "state matches",
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Speedtyper.enabled." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.state_type_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(
            child,
            "type(_G.Speedtyper.state." .. field .. ")",
            value
        )
    end,
    errorMessage
