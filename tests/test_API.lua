...
T["setup()"]["sets exposed methods and default options value"] = function()
    child.lua([[require('speedtyper').setup()]])

    -- global object that holds your plugin information
    eq_type_global(child, "_G.Speedtyper", "table")

    -- public methods
    eq_type_global(child, "_G.Speedtyper.toggle", "function")
    eq_type_global(child, "_G.Speedtyper.disable", "function")
    eq_type_global(child, "_G.Speedtyper.enable", "function")

    -- config
    eq_type_global(child, "_G.Speedtyper.config", "table")
