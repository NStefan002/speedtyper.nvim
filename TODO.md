...
- [x] move `util.notify()` to a separate module, and play sounds when notifying
- [ ] fix loop require `sounds` -> `notify` -> `sounds` when there aren't any tools for playing sounds installed
